"""The unit of work: everything caltrust needs to audit one camera.
...
#: Hand-eye conventions caltrust accepts on input. Everything is stored as
...
class CalibrationSession:
    """Everything caltrust needs to audit one camera.
    ...
    Attributes:
        ...
        caltrust_version: Version that produced the session.
