...
FORMAT = "calibsense.detections"


def write_detections(observations: ObservationSet, path: str) -> str:
    """Write detections as calibsense JSON.
...
def read_detections(
    ...
    Two shapes are accepted. A calibsense JSON file carries its own target and
