...
class RefitOptions:
    ...
    Attributes:
        ...
        fixed: Intrinsic parameter names to hold rather than estimate. What
            ...
            calibsense's: `cv2.calibrateCamera` keeps a fixed pinhole coefficient
...
class InstrumentedFit:
    ...
    Attributes:
        ...
        cross_validation: Out-of-sample results, when they were computed. Not
            ...
            `dataclasses.replace` after calling `calibsense.validate.cross_validate`.
        created: ISO-8601 UTC timestamp.
        calibsense_version: Version that produced the fit.
    """
